...
export function AstrolabeLoader({ className }: Props) {
  return (
    <div className={`relative ${className ?? "w-44 h-44"}`}>
      <svg
        viewBox="0 0 180 180"
        aria-hidden="true"
        className="w-full h-full animate-pet-loading-spin motion-reduce:animate-none origin-center"
      >
        <defs>
          <radialGradient id="astrolabeBg" cx="0.5" cy="0.5" r="0.6">
      ...
      <div className="absolute inset-0 flex items-center justify-center animate-pet-loading-pulse motion-reduce:animate-none">
        ...
        >
          <defs>
            <linearGradient id="astrolabeMoon" x1="0" y1="0" x2="0" y2="1">
